            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="class-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("class/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-class_ID"  value="<?php  echo $this->set_field_value('class_ID',""); ?>" type="text" placeholder="Nhập mã lớp"  required="" name="class_ID"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-class_name"  value="<?php  echo $this->set_field_value('class_name',""); ?>" type="text" placeholder="Nhập tên lớp"  required="" name="class_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-age"  value="<?php  echo $this->set_field_value('age',""); ?>" type="text" placeholder="ageber Of Girls"  required="" name="age"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
