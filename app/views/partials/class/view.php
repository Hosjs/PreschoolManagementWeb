                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr class="td-class_ID">
                                        ...
                                        <td class="value">
                                            <span><?php echo $data['class_ID']; ?></span>
                                        </td>
                                    </tr>
                                    <tr class="td-class_name">
                                        <th class="title"> Tên lớp: </th>
                                        <td class="value">
                                            <span><?php echo $data['class_name']; ?></span>
                                        </td>
                                    </tr>
                                    <tr class="td-age">
                                    ...
                                    <tr class="td-assigned_teacher">
                                        ...
                                        <td class="value">
                                            <span><?php echo $data['assigned_teacher']; ?></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="td-room">
                                        ...
                                        <td class="value">
                                            <span><?php echo $data['room']; ?></span>
                                        </td>
                                    </tr>
                                    <tr class="td-class_score">
                                        <th class="title"> Điểm thi đua: </th>
                                        <td class="value">
                                            <span><?php echo $data['class_score']; ?></span>
                                        </td>
                                    </tr>
                                    <tr class="td-study_time">
                                        <th class="title"> Năm học: </th>
                                        <td class="value">
