                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th class="td-download"> Tải xuống</th>
                                            <th class="td-date"> Ngày</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-assignment_name">
                                                <span <?php if($can_edit){ ?>
                                                    data-value="<?php echo $data['assignment_name']; ?>"
                                                    data-pk="<?php echo $data['id'] ?>"
                                                    data-url="<?php print_link("assignment/editfield/" . urlencode($data['id'])); ?>"
                                                    data-name="assignment_name" data-title="Nhập tên bài tập"
                                            ...
                                            <td class="td-assignment_type">
                                                <span <?php if($can_edit){ ?>
                                                    data-source='<?php echo json_encode_quote(Menu :: $assignment_type); ?>'
                                                    data-value="<?php echo $data['assignment_type']; ?>"
                                                    data-pk="<?php echo $data['id'] ?>"
                                                    data-url="<?php print_link("assignment/editfield/" . urlencode($data['id'])); ?>"
                                                    data-name="assignment_type" data-title="Select a value ..."
                                            ...
                                            <td class="td-download"><a class="btn btn-sm btn-light"
                                                    href="<?php echo $data['download']; ?>"><i
                                                        class="fa fa-file"></i><?php echo " ".$data['download']; ?></a>
                                            </td>
                                            <td class="td-date">
                                                <span <?php if($can_edit){ ?>
                                                    data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}"
                                                    data-value="<?php echo $data['date']; ?>"
                                                    data-pk="<?php echo $data['id'] ?>"
                                                    data-url="<?php print_link("assignment/editfield/" . urlencode($data['id'])); ?>"
                                                    data-name="date" data-title="Enter Date" data-placement="left"
                                                    data-toggle="click" data-type="flatdatetimepicker"
                                                    data-mode="popover" data-showbuttons="left" class="is-editable"
                                                    <?php } ?>>
                                                    <?php echo $data['date']; ?>
                                                </span>
                                            ...
                                            <th class="td-btn">
                                                ...
                                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                    ...
                                                    href="<?php print_link("assignment/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
                                    ...
                                    <div class="col-md-auto justify-content-center">
                                        <div class="p-3 d-flex justify-content-between">
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records?"
                                                data-display-style="modal"
                                                data-url="<?php print_link("assignment/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
                                                class="btn btn-sm btn-danger btn-delete-selected d-none">
                                                <i class="material-icons">clear</i> Xóa phần đã chọn
                                            </button>
                                            <?php } ?>
                                            <div class="dropup export-btn-holder mx-1">
                                                <button class="btn btn-sm btn-primary dropdown-toggle" type="button"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="material-icons">save</i> Xuất file
                                                </button>
