...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view" data-display-type="table"
    ...
    <div class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Xem thông tin</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr class="td-content">
                                        <th class="title"> Tải xuống : </th>
                                        <td class="value"> <a class="btn btn-sm btn-light"
                                                href="<?php echo $data['download']; ?>"><i
                                                    class="fa fa-file"></i><?php echo " ".$data['download']; ?></a></td>
                                    </tr>
                                    <tr class="td-date">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?>
                                                ...
                                                data-toggle="click" data-type="flatdatetimepicker" data-mode="popover"
