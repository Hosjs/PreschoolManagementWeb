        ...
        ?>
            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card shadow-sm h-100">
                    ...
                    <img src="<?= $data['photo'] ?? 'uploads/default-avatar.png' ?>" class="card-img-top"
                        alt="Ảnh học sinh" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <?= $data['attendance'] == 'yes' ? 'Có mặt' : ($data['attendance'] == 'no' ? 'Vắng mặt' : 'Chưa điểm danh') ?>
                        </p>
