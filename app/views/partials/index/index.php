                            ...
                            <div>
                                ...
                                <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                                    ...
                                    <div class="row clearfix mt-3 mb-3">
                                        ...
                                        <div class="col-6">
                                            <a href="<?php print_link('passwordmanager') ?>" class="text-danger"> Reset Mật khẩu?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        Không có tài khoản? <a href="<?php print_link("index/register") ?>" class="btn btn-success">Đăng ký
