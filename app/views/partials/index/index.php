                ...
                <div class="row ">
                        ...
                        <div class="">
                            <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                    <h2 class="text-capitalize">Chào mừng đến với <?php echo SITE_NAME ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 comp-grid">
                        ...
                        <div class="bg-light p-3 animated fadeIn page-content">
                            <div>
                                <h4><i class="material-icons">lock_open</i>Đăng nhập tài khoản</h4>
                                <hr />
                                <?php 
                                ...
                                <form name="loginForm"
                                    ...
                                    <div class="input-group form-group">
                                        <input placeholder="Tên đăng nhập" name="username" required="required"
                                    ...
                                    <div class="input-group form-group">
                                        <input placeholder="Mật khẩu" required="required" v-model="user.password"
                                    ...
                                    <div class="row clearfix mt-3 mb-3">
                                        ...
                                        <div class="col-6">
                                            <a href="<?php print_link('passwordmanager') ?>" class="text-danger"> Quên
                                                mật khẩu?</a>
                                        </div>
                                    </div>
