...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit" data-display-type=""
    ...
    <div class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Sửa thông báo</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate id="" role="form" enctype="multipart/form-data"
                            ...
                            action="<?php print_link("announcement/edit/$page_id/?csrf_token=$csrf_token"); ?>"
                            method="post">
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-date" class="form-control datepicker  datepicker"
                                                    ...
                                                    name="date" placeholder="Nhập ngày đăng" data-enable-time="true"
