            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div class="bg-light p-3 animated fadeIn page-content">
                        <form id="subject-add-form" role="form" novalidate enctype="multipart/form-data"
                            class="form page-form form-horizontal needs-validation"
                            action="<?php print_link("subject/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="">
                                                <div class="dropzone required" input="#ctrl-content" fieldname="content"
                                                    ...
                                                    <input name="content" id="ctrl-content" required=""
                                                        ...
                                                        value="<?php  echo $this->set_field_value('content',""); ?>"
                                                        type="text" />
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-date" class="form-control datepicker  datepicker"
                                                    ...
                                                    type="datetime" name="date" placeholder="Nhập thời gian"
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-terms"
                                                    value="<?php  echo $this->set_field_value('terms',""); ?>"
                                                    type="text" placeholder="Nhập điều kiện tham gia" required
                                                    name="terms" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-fee"
                                                    value="<?php  echo $this->set_field_value('fee',""); ?>"
                                                    type="number" step="0.01" placeholder="Nhập chi phí tham gia"
                                                    required name="fee" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
