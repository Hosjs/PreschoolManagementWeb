...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list" data-display-type="table"
    ...
    <div class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Phương thức thanh toán</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <th class="td-sno">STT</th>
                                            <th class="td-id"> Id</th>
                                            <th class="td-fullname_of_depositor"> Tên tài khoản thụ hưởng</th>
                                            <th class="td-payment_method"> Phương thức thanh toán</th>
                                            <th class="td-transaction_code"> Số tài khoản</th>
                                            <th class="td-amount"> Học phí</th>
                                            <th class="td-transaction_date"> Hạn thu học phí</th>
                                            <th class="td-comments"> Ghi chú</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-id"><a
                                                    href="<?php print_link("how_to_make_payment/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                            </td>
                                            ...
                                            <td class="td-transaction_date">
                                                <span <?php if($can_edit){ ?>
                                                    ...
                                                    data-placement="left" data-toggle="click"
                                                    data-type="flatdatetimepicker" data-mode="popover"
                                                    data-showbuttons="left" class="is-editable" <?php } ?>>
                                            ...
                                            <td class="td-comments">
                                                <span <?php if($can_edit){ ?> data-pk="<?php echo $data['id'] ?>"
                                                    data-url="<?php print_link("how_to_make_payment/editfield/" . urlencode($data['id'])); ?>"
                                                    data-name="comments" data-title="Enter Comments"
                                                    data-placement="left" data-toggle="click" data-type="textarea"
                                                    data-mode="popover" data-showbuttons="left" class="is-editable"
                                                    <?php } ?>>
                                            ...
                                            <th class="td-btn">
                                                ...
                                                <a class="btn btn-sm btn-success has-tooltip" title="View Record"
                                                    href="<?php print_link("how_to_make_payment/view/$rec_id"); ?>">
                                    ...
                                    <div class="col-md-auto justify-content-center">
                                        <div class="p-3 d-flex justify-content-between">
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records?"
                                                data-display-style="modal"
                                                data-url="<?php print_link("how_to_make_payment/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
