                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-with_birth_certificate">
                                        <th class="title"> Đăng ký cơm trưa: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-special_conditions">
                                        <th class="title"> Có mặt trong lớp: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-parent_contact_no">
                                        <th class="title"> Thông tin liên lạc với phụ huynh: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-father_full_name">
                                        <th class="title"> Tên đầy đủ của bố: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-mother_full_name">
                                        <th class="title"> Tên đầy đủ của mẹ: </th>
                                        <td class="value">
                        ...
                        <div class="p-3 d-flex">
                            <div class="dropup export-btn-holder mx-1">
                                <button class="btn btn-sm btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="material-icons"></i>Lưu & Xuất
                                </button>
