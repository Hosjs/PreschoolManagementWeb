            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="student-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("student/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-pupils_ID"  value="<?php  echo $this->set_field_value('pupils_ID',""); ?>" type="text" placeholder="Enter Student ID"  required="" name="pupils_ID"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
