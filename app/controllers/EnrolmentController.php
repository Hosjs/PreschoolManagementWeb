...
class EnrolmentController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("enrol_year","number_of_boy","number_of_girls","age_above_10","number_of_dropout","transfer","total_pupils_in_school","pupils_with_upi","pupils_birth_certificate","pupils_without_certificate");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","enrol_year","number_of_boy","number_of_girls","age_above_10","number_of_dropout","transfer","total_pupils_in_school","pupils_with_upi","pupils_birth_certificate","pupils_without_certificate");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'enrol_year' => 'required',
